...
const refundSchema = z.object({
  ...
  amount: z.coerce.number({ message: "Informe um valor válido" }).positive({
    message: "Informe um valor válido e superior a 0",
  }),
});
...
export function Refund() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      alert ("Não foi possível realizar a solicitação de reembolso.")
    } finally {
      setIsLoading(false)
    }
  }
  ...
  async function fetchRefund(id: string) {
     try {
      ...
      setFileURL(data.filename)
        ...
        return("Não foi possível carregar os dados da solicitação.")
